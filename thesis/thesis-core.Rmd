...
The materials for Study 1 are available at https://osf.io/e428p, while the materials for Study 2 are at https://osf.io/ueryq.
...
```{r, child = 'thesis/Introduction.Rmd'}
```

\clearpage

```{r, child = 'thesis/Chapter-1.Rmd'}
```

\clearpage

```{r, child = 'thesis/Chapter-2.Rmd'}
```

\clearpage

```{r, child = 'thesis/General-discussion.Rmd'}
```
