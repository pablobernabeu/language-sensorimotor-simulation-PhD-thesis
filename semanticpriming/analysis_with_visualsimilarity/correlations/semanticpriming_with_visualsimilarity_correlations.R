...
(semanticpriming_with_visualsimilarity %>%
    ...
    select(z_target.RT, z_vocabulary_size, z_attentional_control, 
           ...
           z_visual_similarity, z_word_concreteness_diff, 
  ...
  # Save
  ggsave(filename = 'semanticpriming/analysis_with_visualsimilarity/correlations/plots/semanticpriming_with_visualsimilarity_correlations.pdf',
