...
# 1. Interaction between attentional control and language-based similarity
# 2. Interaction between attentional control and visual-strength difference
...
( plot1 + plot2 + 
  ...
  ggsave(filename = 'semanticpriming/frequentist_analysis/plots/semanticpriming-interactions-with-attentional-control.pdf',
