...
( plot.fixef.allFit(semanticpriming_allFit_convergence, 
  ...
  # Save plot
  ggsave(filename = 'semanticpriming/frequentist_analysis/model_diagnostics/plots/main_effects_semanticpriming_allFit_convergence.pdf', 
...
( plot.fixef.allFit(semanticpriming_allFit_convergence, 
                    ...
                    multiply_y_axis_limits = 1.3) ) %>%
  # Save plot
  ggsave(filename = 'semanticpriming/frequentist_analysis/model_diagnostics/plots/interactions_semanticpriming_allFit_convergence.pdf', 
