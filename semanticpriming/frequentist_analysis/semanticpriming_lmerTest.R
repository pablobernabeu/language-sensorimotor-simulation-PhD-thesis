...
saveRDS(semanticpriming_lmerTest, 
        'semanticpriming/frequentist_analysis/results/semanticpriming_lmerTest.rds')

# Calculate p values using Kenward-Roger method (Luke, 2017; 
# https://doi.org/10.3758/s13428-016-0809-y)
summary(semanticpriming_lmerTest, ddf = 'Kenward-Roger') %>%
  saveRDS('semanticpriming/frequentist_analysis/results/KR_summary_semanticpriming_lmerTest.rds')
...
MuMIn::r.squaredGLMM(semanticpriming_lmerTest) %>%
  saveRDS('semanticpriming/frequentist_analysis/results/Nakagawa2017_R2_semanticpriming_lmerTest.rds')
...
lme4::confint.merMod(semanticpriming_lmerTest, method = 'profile',
  ...
  saveRDS('semanticpriming/frequentist_analysis/results/confint_semanticpriming_lmerTest.rds')

# Save random effects
lme4::ranef(semanticpriming_lmerTest) %>%
  saveRDS('semanticpriming/frequentist_analysis/results/ranef_semanticpriming_lmerTest.rds')
