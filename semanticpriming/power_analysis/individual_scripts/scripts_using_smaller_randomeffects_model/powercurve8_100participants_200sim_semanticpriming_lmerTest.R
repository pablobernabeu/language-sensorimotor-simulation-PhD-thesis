...
fixef(semanticpriming_lmerTest)['z_recoded_interstimulus_interval:z_cosine_similarity'] = 
  fixef(semanticpriming_lmerTest)['z_recoded_interstimulus_interval:z_cosine_similarity'] * 0.8
...
powercurve8 = powerCurve(extendedparticipants_semanticpriming_lmerTest,
                         ...
                         fixed('z_recoded_interstimulus_interval:z_cosine_similarity', method = 'sa'), 
...
saveRDS(powercurve8, 
        'semanticpriming/power_analysis/results/powercurve8_100participants_200sim_semanticpriming_lmerTest.rds')
