...
fixef(semanticpriming_lmerTest)['z_visual_rating_diff'] = 
  fixef(semanticpriming_lmerTest)['z_visual_rating_diff'] * 0.8
...
powercurve2 = powerCurve(extendedparticipants_semanticpriming_lmerTest,
                         ...
                         fixed('z_visual_rating_diff', method = 'sa'), 
...
saveRDS(powercurve2, 
        'semanticpriming/power_analysis/results/powercurve2_300participants_200sim_semanticpriming_lmerTest.rds')
