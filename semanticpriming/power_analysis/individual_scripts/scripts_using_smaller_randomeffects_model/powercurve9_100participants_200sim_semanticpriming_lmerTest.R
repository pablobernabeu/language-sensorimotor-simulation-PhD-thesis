...
semanticpriming_lmerTest = 
  readRDS('semanticpriming/power_analysis/reduced_randomeffects_model/results/semanticpriming_lmerTest.rds')
...
fixef(semanticpriming_lmerTest)['z_recoded_interstimulus_interval:z_visual_rating_diff'] = 
  fixef(semanticpriming_lmerTest)['z_recoded_interstimulus_interval:z_visual_rating_diff'] * 0.8
...
extendedparticipants_semanticpriming_lmerTest = 
  extend(semanticpriming_lmerTest, along = 'Participant', n = 2000)
...
powercurve9 = powerCurve(extendedparticipants_semanticpriming_lmerTest,
                         ...
                         fixed('z_recoded_interstimulus_interval:z_visual_rating_diff', method = 'sa'), 

                         # for the following number of participants
                         along = 'Participant', breaks = 100,
...
saveRDS(powercurve9, 
        'semanticpriming/power_analysis/results/powercurve9_100participants_200sim_semanticpriming_lmerTest.rds')
