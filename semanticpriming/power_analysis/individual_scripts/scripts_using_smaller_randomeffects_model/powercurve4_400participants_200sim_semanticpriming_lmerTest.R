...
fixef(semanticpriming_lmerTest)['z_vocabulary_size:z_cosine_similarity'] = 
  fixef(semanticpriming_lmerTest)['z_vocabulary_size:z_cosine_similarity'] * 0.8
...
powercurve4 = powerCurve(extendedparticipants_semanticpriming_lmerTest,
                         ...
                         fixed('z_vocabulary_size:z_cosine_similarity', method = 'sa'), 
...
saveRDS(powercurve4, 
        'semanticpriming/power_analysis/results/powercurve4_400participants_200sim_semanticpriming_lmerTest.rds')
