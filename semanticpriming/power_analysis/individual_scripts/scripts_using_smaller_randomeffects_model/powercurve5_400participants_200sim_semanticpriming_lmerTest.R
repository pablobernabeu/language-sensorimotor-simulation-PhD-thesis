...
fixef(semanticpriming_lmerTest)['z_vocabulary_size:z_visual_rating_diff'] = 
  fixef(semanticpriming_lmerTest)['z_vocabulary_size:z_visual_rating_diff'] * 0.8
...
powercurve5 = powerCurve(extendedparticipants_semanticpriming_lmerTest,
                         ...
                         fixed('z_vocabulary_size:z_visual_rating_diff', method = 'sa'), 
...
saveRDS(powercurve5, 
        'semanticpriming/power_analysis/results/powercurve5_400participants_200sim_semanticpriming_lmerTest.rds')
