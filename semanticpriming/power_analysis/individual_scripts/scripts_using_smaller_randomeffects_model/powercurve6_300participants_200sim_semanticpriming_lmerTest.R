...
fixef(semanticpriming_lmerTest)['z_recoded_participant_gender:z_cosine_similarity'] = 
  fixef(semanticpriming_lmerTest)['z_recoded_participant_gender:z_cosine_similarity'] * 0.8
...
powercurve6 = powerCurve(extendedparticipants_semanticpriming_lmerTest,
                         ...
                         fixed('z_recoded_participant_gender:z_cosine_similarity', method = 'sa'), 
...
saveRDS(powercurve6, 
        'semanticpriming/power_analysis/results/powercurve6_300participants_200sim_semanticpriming_lmerTest.rds')
