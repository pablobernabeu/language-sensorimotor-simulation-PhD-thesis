...
fixef(semanticpriming_lmerTest)['z_vocabulary_size'] = 
  fixef(semanticpriming_lmerTest)['z_vocabulary_size'] * 0.8
...
powercurve3 = powerCurve(extendedparticipants_semanticpriming_lmerTest,
                         ...
                         fixed('z_vocabulary_size', method = 'sa'), 
...
saveRDS(powercurve3, 
        'semanticpriming/power_analysis/results/powercurve3_400participants_200sim_semanticpriming_lmerTest.rds')
