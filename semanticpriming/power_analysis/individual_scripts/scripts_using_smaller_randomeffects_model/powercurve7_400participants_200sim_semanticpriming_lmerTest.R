...
fixef(semanticpriming_lmerTest)['z_recoded_participant_gender:z_visual_rating_diff'] = 
  fixef(semanticpriming_lmerTest)['z_recoded_participant_gender:z_visual_rating_diff'] * 0.8
...
powercurve7 = powerCurve(extendedparticipants_semanticpriming_lmerTest,
                         ...
                         fixed('z_recoded_participant_gender:z_visual_rating_diff', method = 'sa'), 
...
saveRDS(powercurve7, 
        'semanticpriming/power_analysis/results/powercurve7_400participants_200sim_semanticpriming_lmerTest.rds')
