...
fixef(semanticpriming_lmerTest)['z_cosine_similarity'] = 
  fixef(semanticpriming_lmerTest)['z_cosine_similarity'] * 0.8
...
powercurve1 = powerCurve(extendedparticipants_semanticpriming_lmerTest,
                         ...
                         fixed('z_cosine_similarity', method = 'sa'), 
...
saveRDS(powercurve1, 
        'semanticpriming/power_analysis/results/powercurve1_400participants_200sim_semanticpriming_lmerTest.rds')
