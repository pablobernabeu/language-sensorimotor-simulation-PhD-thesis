...
KR_summary_semanticpriming_lmerTest = 
  readRDS("semanticpriming/power_analysis/model/results/KR_summary_semanticpriming_lmerTest.rds")
...
saveRDS(semanticpriming_robustlmm, 
        'semanticpriming/model/model_diagnostics/results/semanticpriming_robustlmm.rds')
