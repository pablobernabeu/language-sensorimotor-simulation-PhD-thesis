...
semanticpriming_brms_weaklyinformativepriors_exgaussian =
...
# saveRDS(semanticpriming_brms_weaklyinformativepriors_exgaussian,
#         'semanticpriming/bayesian_analysis/results/semanticpriming_brms_weaklyinformativepriors_exgaussian.rds')

# Model summary
summary(semanticpriming_brms_weaklyinformativepriors_exgaussian) %>%
  saveRDS('semanticpriming/bayesian_analysis/results/semanticpriming_summary_weaklyinformativepriors_exgaussian.rds')
...
pp_check(semanticpriming_brms_weaklyinformativepriors_exgaussian, ndraws = 100) %>%
  saveRDS('semanticpriming/bayesian_analysis/posterior_predictive_checks/semanticpriming_posteriorpredictivecheck_weaklyinformativepriors_exgaussian.rds') 

# Plot posterior distribution of each fixed effect (i.e., effects commencing with 'b_')
mcmc_plot(semanticpriming_brms_weaklyinformativepriors_exgaussian, 
          type = 'areas', variable = '^b_', regex = TRUE) %>%
  saveRDS('semanticpriming/bayesian_analysis/results/posteriordistributions_semanticpriming_weaklyinformativepriors_exgaussian.rds')
