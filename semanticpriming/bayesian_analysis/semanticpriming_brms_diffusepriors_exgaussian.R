...
semanticpriming_brms_diffusepriors_exgaussian =
  ...
  brm(
    ...
    data = semanticpriming, prior = diffuse_priors,
...
# saveRDS(semanticpriming_brms_diffusepriors_exgaussian,
#         'semanticpriming/bayesian_analysis/results/semanticpriming_brms_diffusepriors_exgaussian.rds')

# Model summary
summary(semanticpriming_brms_diffusepriors_exgaussian) %>%
  saveRDS('semanticpriming/bayesian_analysis/results/semanticpriming_summary_diffusepriors_exgaussian.rds')
...
pp_check(semanticpriming_brms_diffusepriors_exgaussian, ndraws = 100) %>%
  saveRDS('semanticpriming/bayesian_analysis/posterior_predictive_checks/semanticpriming_posteriorpredictivecheck_diffusepriors_exgaussian.rds') 

# Plot posterior distribution of each fixed effect (i.e., effects commencing with 'b_')
mcmc_plot(semanticpriming_brms_diffusepriors_exgaussian, 
          type = 'areas', variable = '^b_', regex = TRUE) %>%
  saveRDS('semanticpriming/bayesian_analysis/results/posteriordistributions_semanticpriming_diffusepriors_exgaussian.rds')
