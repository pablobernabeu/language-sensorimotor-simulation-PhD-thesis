...
semanticdecision_brms_diffusepriors_exgaussian =
  ...
  brm(
    ...
    iter = 16000, chains = 16,  # (iter - warmup) x chains = total post-warmup draws (brms v2.17.0)
...
summary(semanticdecision_brms_diffusepriors_exgaussian) %>%
  saveRDS('semanticdecision/bayesian_analysis/divergent_models/results/semanticdecision_summary_diffusepriors_exgaussian.rds')
