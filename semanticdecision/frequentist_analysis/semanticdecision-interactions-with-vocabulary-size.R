...
# 1. Interaction between vocabulary size and word co-occurrence
# 2. Interaction between vocabulary size and visual strength
# 3. Interaction between vocabulary size and word concreteness
...
( plot1 + plot2 + plot3 + 
  ...
  ggsave(filename = 'semanticdecision/frequentist_analysis/plots/semanticdecision-interactions-with-vocabulary-size.pdf',
