...
cl = makeCluster(rep("localhost", nc), outfile = "semanticdecision_GLMM.cl.log.txt")
...
afex::mixed( RTclean ~
  ...
  saveRDS('semanticpriming/frequentist_analysis/model_diagnostics/results/semanticdecision_GLMM.rds')
...
#    16 nodes produced errors; first error: NA/NaN/Inf in 'y'
#  Calls: system.time ... .do_sampling -> unlist -> clusterCall -> checkForRemoteErrors
# 
#############
