...
system.time({
  ...
  lexical_covariates_selection_semanticdecision_lmerTest =
...
saveRDS(lexical_covariates_selection_semanticdecision_lmerTest, 
        'semanticdecision/frequentist_analysis/lexical_covariates_selection/results/lexical_covariates_selection_semanticdecision_lmerTest.rds')

# Calculate p values using Kenward-Roger method (Luke, 2017; 
# https://doi.org/10.3758/s13428-016-0809-y)
summary(lexical_covariates_selection_semanticdecision_lmerTest, ddf = 'Kenward-Roger') %>%
  saveRDS('semanticdecision/frequentist_analysis/lexical_covariates_selection/results/KR_summary_lexical_covariates_selection_semanticdecision_lmerTest.rds')
...
MuMIn::r.squaredGLMM(lexical_covariates_selection_semanticdecision_lmerTest) %>%
  saveRDS('semanticdecision/frequentist_analysis/lexical_covariates_selection/results/Nakagawa2017_R2_lexical_covariates_selection_semanticdecision_lmerTest.rds')

# Calculate 95% confidence intervals of fixed effects
lme4::confint.merMod(lexical_covariates_selection_semanticdecision_lmerTest, method = 'profile',
                     # Compute 95% CIs for every effect, as well as for the intercept
                     parm = rownames(summary(lexical_covariates_selection_semanticdecision_lmerTest)$coefficients)) %>%
  saveRDS('semanticdecision/frequentist_analysis/lexical_covariates_selection/results/confint_lexical_covariates_selection_semanticdecision_lmerTest.rds')
