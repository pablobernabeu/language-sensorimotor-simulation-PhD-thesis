...
files_list = 
  list.files(pattern = '*.rds', full.names = TRUE,
             path = 'semanticdecision/power_analysis/results') %>% 
  map(readRDS)
...
for(i in 1 : length(files_list)) {
  files_list[[i]]['text'] = files_list[[i]]['text'] %>% 
    ...
    # the word-level variables (i.e., 'z_word_cooccurrence' and 'z_visual_rating') 
...
semanticdecision_powercurve_plots_1_2_3 = 
  powercurve1_plot + powercurve2_plot + 
  powercurve3_plot + plot_layout(nrow = 2)

semanticdecision_powercurve_plots_4_5_6_7 = 
...
semanticdecision_powercurve_plots_1_2_3[[1]] = 
  semanticdecision_powercurve_plots_1_2_3[[1]] + 
  theme(axis.title.x = element_blank(),
        plot.margin = margin(8, 2, 0, 0))

semanticdecision_powercurve_plots_1_2_3[[2]] = 
  semanticdecision_powercurve_plots_1_2_3[[2]] + 
  theme(axis.title.y = element_blank(),
        plot.margin = margin(8, 0, 0, 0))

semanticdecision_powercurve_plots_1_2_3[[3]] = 
  semanticdecision_powercurve_plots_1_2_3[[3]] + 
  theme(plot.margin = margin(0, 2, 11, 0))

semanticdecision_powercurve_plots_4_5_6_7[[1]] = 
  semanticdecision_powercurve_plots_4_5_6_7[[1]] + 
  theme(axis.title.x = element_blank(),
        plot.margin = margin(8, 2, 15, 0))

semanticdecision_powercurve_plots_4_5_6_7[[2]] = 
  semanticdecision_powercurve_plots_4_5_6_7[[2]] + 
  theme(axis.title.x = element_blank(),
        axis.title.y = element_blank(),
        plot.margin = margin(8, 0, 15, 0))

semanticdecision_powercurve_plots_4_5_6_7[[3]] = 
  semanticdecision_powercurve_plots_4_5_6_7[[3]] + 
  theme(plot.margin = margin(0, 2, 11, 0))

semanticdecision_powercurve_plots_4_5_6_7[[4]] = 
  semanticdecision_powercurve_plots_4_5_6_7[[4]] + 
  theme(axis.title.y = element_blank(),
...
ggsave('semanticdecision/power_analysis/plots/semanticdecision_powercurve_plots_1_2_3.pdf', 
       plot = semanticdecision_powercurve_plots_1_2_3, device = cairo_pdf, 
       width = 7, height = 6.4, units = 'in', dpi = 800)

ggsave('semanticdecision/power_analysis/plots/semanticdecision_powercurve_plots_4_5_6_7.pdf', 
       plot = semanticdecision_powercurve_plots_4_5_6_7, device = cairo_pdf, 
       width = 7, height = 6.4, units = 'in', dpi = 800)


# Free up workspace
# rm(list = c('semanticdecision_powercurve_plots_1_2_3', 
#             'semanticdecision_powercurve_plots_4_5_6_7'))
