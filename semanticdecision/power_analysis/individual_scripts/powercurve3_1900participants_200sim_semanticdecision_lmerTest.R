...
fixef(semanticdecision_lmerTest)['z_vocabulary_size'] = 
  fixef(semanticdecision_lmerTest)['z_vocabulary_size'] * 0.8
...
powercurve3 = powerCurve(extendedparticipants_semanticdecision_lmerTest,
...
saveRDS(powercurve3, 
  'semanticdecision/power_analysis/results/powercurve3_1900participants_200sim_semanticdecision_lmerTest.rds')
