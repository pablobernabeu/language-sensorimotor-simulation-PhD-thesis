...
fixef(semanticdecision_lmerTest)['z_vocabulary_size:z_word_cooccurrence'] = 
  fixef(semanticdecision_lmerTest)['z_vocabulary_size:z_word_cooccurrence'] * 0.8
...
powercurve4 = powerCurve(extendedparticipants_semanticdecision_lmerTest,
                         ...
                         fixed('z_vocabulary_size:z_word_cooccurrence', method = 'sa'), 
...
saveRDS(powercurve4, 
  'semanticdecision/power_analysis/results/powercurve4_1400participants_200sim_semanticdecision_lmerTest.rds')
