...
fixef(semanticdecision_lmerTest)['z_vocabulary_size:z_visual_rating'] = 
  fixef(semanticdecision_lmerTest)['z_vocabulary_size:z_visual_rating'] * 0.8
...
powercurve5 = powerCurve(extendedparticipants_semanticdecision_lmerTest,
                         ...
                         fixed('z_vocabulary_size:z_visual_rating', method = 'sa'), 
...
saveRDS(powercurve5, 
  'semanticdecision/power_analysis/results/powercurve5_1900participants_200sim_semanticdecision_lmerTest.rds')
