...
fixef(semanticdecision_lmerTest)['z_word_cooccurrence'] = 
  fixef(semanticdecision_lmerTest)['z_word_cooccurrence'] * 0.8
...
powercurve1 = powerCurve(extendedparticipants_semanticdecision_lmerTest,
                         ...
                         fixed('z_word_cooccurrence', method = 'sa'), 
...
saveRDS(powercurve1, 
  'semanticdecision/power_analysis/results/powercurve1_1900participants_200sim_semanticdecision_lmerTest.rds')
