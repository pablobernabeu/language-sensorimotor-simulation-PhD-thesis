...
fixef(semanticdecision_lmerTest)['z_recoded_participant_gender:z_visual_rating'] = 
  fixef(semanticdecision_lmerTest)['z_recoded_participant_gender:z_visual_rating'] * 0.8
...
powercurve7 = powerCurve(extendedparticipants_semanticdecision_lmerTest,
                         ...
                         fixed('z_recoded_participant_gender:z_visual_rating', method = 'sa'), 

                         # for the following number of participants
                         along = 'Participant', breaks = 1900,
...
saveRDS(powercurve7, 
  'semanticdecision/power_analysis/results/powercurve7_1900participants_200sim_semanticdecision_lmerTest.rds')
