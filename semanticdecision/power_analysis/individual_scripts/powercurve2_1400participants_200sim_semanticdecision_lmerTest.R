...
fixef(semanticdecision_lmerTest)['z_visual_rating'] = 
  fixef(semanticdecision_lmerTest)['z_visual_rating'] * 0.8
...
powercurve2 = powerCurve(extendedparticipants_semanticdecision_lmerTest,
                         ...
                         fixed('z_visual_rating', method = 'sa'), 
...
saveRDS(powercurve2, 
  'semanticdecision/power_analysis/results/powercurve2_1400participants_200sim_semanticdecision_lmerTest.rds')
