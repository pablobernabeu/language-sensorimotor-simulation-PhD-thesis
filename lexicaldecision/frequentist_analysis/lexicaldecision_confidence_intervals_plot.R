...
KR_summary_lexicaldecision_lmerTest =   # Model summary with Kenward-Roger p values
...
( plot_95_confidence_intervals(
  ...
  # Save plot
  ggsave(filename = 'lexicaldecision/frequentist_analysis/plots/lexicaldecision_confidence_intervals_plot.pdf', 
         device = cairo_pdf, width = 4, height = 5, dpi = 900)
