...
(lexicaldecision[, c('z_phonological_Levenshtein_distance', 
  ...
  # Save
  ggsave(filename = 'lexicaldecision/frequentist_analysis/lexical_covariates_selection/plots/lexicaldecision_lexical_covariates_correlations.pdf',
