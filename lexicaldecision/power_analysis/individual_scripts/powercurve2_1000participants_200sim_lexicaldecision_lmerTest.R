...
fixef(lexicaldecision_lmerTest)['z_visual_rating'] = 
  fixef(lexicaldecision_lmerTest)['z_visual_rating'] * 0.8
...
powercurve2 = powerCurve(extendedparticipants_lexicaldecision_lmerTest,
...
saveRDS(powercurve2, 
  'lexicaldecision/power_analysis/results/powercurve2_1000participants_200sim_lexicaldecision_lmerTest.rds')
