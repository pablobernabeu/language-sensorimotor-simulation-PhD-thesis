...
fixef(lexicaldecision_lmerTest)['z_vocabulary_age:z_visual_rating'] = 
  fixef(lexicaldecision_lmerTest)['z_vocabulary_age:z_visual_rating'] * 0.8
...
powercurve5 = powerCurve(extendedparticipants_lexicaldecision_lmerTest,
                         ...
                         fixed('z_vocabulary_age:z_visual_rating', method = 'sa'), 
...
saveRDS(powercurve5, 
  'lexicaldecision/power_analysis/results/powercurve5_1800participants_200sim_lexicaldecision_lmerTest.rds')
