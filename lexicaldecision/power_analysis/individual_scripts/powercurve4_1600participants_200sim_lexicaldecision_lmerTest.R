...
fixef(lexicaldecision_lmerTest)['z_vocabulary_age:z_word_frequency'] = 
  fixef(lexicaldecision_lmerTest)['z_vocabulary_age:z_word_frequency'] * 0.8
...
powercurve4 = powerCurve(extendedparticipants_lexicaldecision_lmerTest,
                         ...
                         fixed('z_vocabulary_age:z_word_frequency', method = 'sa'), 
...
saveRDS(powercurve4, 
  'lexicaldecision/power_analysis/results/powercurve4_1600participants_200sim_lexicaldecision_lmerTest.rds')
