...
fixef(lexicaldecision_lmerTest)['z_word_frequency'] = 
  fixef(lexicaldecision_lmerTest)['z_word_frequency'] * 0.8
...
powercurve1 = powerCurve(extendedparticipants_lexicaldecision_lmerTest,
                         ...
                         fixed('z_word_frequency', method = 'sa'), 
...
saveRDS(powercurve1, 
  'lexicaldecision/power_analysis/results/powercurve1_2000participants_200sim_lexicaldecision_lmerTest.rds')
