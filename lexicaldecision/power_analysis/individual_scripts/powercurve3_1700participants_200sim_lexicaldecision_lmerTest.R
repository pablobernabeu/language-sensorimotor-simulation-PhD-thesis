...
fixef(lexicaldecision_lmerTest)['z_vocabulary_age'] = 
  fixef(lexicaldecision_lmerTest)['z_vocabulary_age'] * 0.8
...
powercurve3 = powerCurve(extendedparticipants_lexicaldecision_lmerTest,
                         ...
                         fixed('z_vocabulary_age', method = 'sa'), 
...
saveRDS(powercurve3, 
  'lexicaldecision/power_analysis/results/powercurve3_1700participants_200sim_lexicaldecision_lmerTest.rds')
