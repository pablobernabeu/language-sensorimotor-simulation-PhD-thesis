...
fixef(lexicaldecision_lmerTest)['z_recoded_participant_gender:z_visual_rating'] = 
  fixef(lexicaldecision_lmerTest)['z_recoded_participant_gender:z_visual_rating'] * 0.8
...
powercurve7 = powerCurve(extendedparticipants_lexicaldecision_lmerTest,
...
saveRDS(powercurve7, 
  'lexicaldecision/power_analysis/results/powercurve7_1200participants_200sim_lexicaldecision_lmerTest.rds')
