...
lexicaldecision_brms_diffusepriors_exgaussian =
...
# saveRDS(lexicaldecision_brms_diffusepriors_exgaussian,
#         'lexicaldecision/bayesian_analysis/results/lexicaldecision_brms_diffusepriors_exgaussian.rds')

# Model summary
summary(lexicaldecision_brms_diffusepriors_exgaussian) %>%
  saveRDS('lexicaldecision/bayesian_analysis/results/lexicaldecision_summary_diffusepriors_exgaussian.rds')
...
pp_check(lexicaldecision_brms_diffusepriors_exgaussian, ndraws = 100) %>%
  saveRDS('lexicaldecision/bayesian_analysis/posterior_predictive_checks/lexicaldecision_posteriorpredictivecheck_diffusepriors_exgaussian.rds') 

# Plot posterior distribution of each fixed effect (i.e., effects commencing with 'b_')
mcmc_plot(lexicaldecision_brms_diffusepriors_exgaussian, 
          type = 'areas', variable = '^b_', regex = TRUE) %>%
  saveRDS('lexicaldecision/bayesian_analysis/results/posteriordistributions_semanticpriming_diffusepriors_exgaussian.rds')
