...
pp_check(lexicaldecision_brms_diffusepriors_exgaussian, ndraws = 100) %>%
  saveRDS('lexicaldecision/bayesian_analysis/divergent_models/posterior_predictive_checks/lexicaldecision_posteriorpredictivecheck_diffusepriors_exgaussian.rds') 
