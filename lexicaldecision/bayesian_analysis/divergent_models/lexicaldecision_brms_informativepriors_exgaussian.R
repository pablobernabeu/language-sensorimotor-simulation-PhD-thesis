...
pp_check(lexicaldecision_brms_informativepriors_exgaussian, ndraws = 100) %>%
  saveRDS('lexicaldecision/bayesian_analysis/divergent_models/posterior_predictive_checks/lexicaldecision_posteriorpredictivecheck_informativepriors_exgaussian.rds') 
